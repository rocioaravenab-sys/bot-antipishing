...
# Canales oficiales por región. Portales principales; el usuario completa la denuncia.
...
REPORT_CHANNELS: dict[str, list[tuple[str, str]]] = {
    "CL": [
...
def report_channels(region: str = DEFAULT_REGION) -> list[tuple[str, str]]:
    """Canales oficiales de denuncia para la región (fallback a la por defecto)."""
    return REPORT_CHANNELS.get(region, REPORT_CHANNELS[DEFAULT_REGION])


# Compat: código que importaba la lista directamente.
REPORT_CHANNELS_CL = REPORT_CHANNELS["CL"]
